...
<html>
    ...
    <main>
        ...
        <!-- Formulier om naam in te vullen -->
        <form class="name-input" method="POST" action="vragenlijst.php">
            ...
            <form method="POST" action="resultaat.php">
                ...
                <div class="main-div">
                    ...
                    <input type="radio" name="vraag1" value="15" required> For music and high-quality sound <br>
                ...
                <div class="main-div">
                    ...
                    <input type="radio" name="vraag2" value="15" required> Absolutely necessary<br>
                ...
                <div class="main-div">
                    ...
                    <input type="radio" name="vraag3" value="15" required> Over-ear<br>
                ...
                <div class="main-div">
                    ...
                    <input type="radio" name="vraag4" value="15" required> It’s the most important factor <br>
                ...
                <div class="main-div">
                    ...
                    <input type="radio" name="vraag5" value="15" required> I want the longest possible battery life <br>
                ...
                <div class="main-div">
                    ...
                    <input type="radio" name="vraag6" value="10" required>Yes, I need sweat resistance<br>
                ...
                <div class="main-div">
                    ...
                    <input type="radio" name="vraag7" value="15" required> Yes, I need great microphone quality <br>
                ...
                <div class="main-div">
                    ...
                    <input type="radio" name="vraag8" value="15" required> Extremely important <br>
                ...
                <div class="main-div">
                    ...
                    <input type="radio" name="vraag9" value="15" required> I want the best, no matter the price <br>
                ...
                <div class="main-div">
                    ...
                    <input type="radio" name="vraag10" value="15" required> Yes, I need strong noise cancellation <br>
                ...
                <div class="main-div">
                    ...
                    <input type="radio" name="vraag11" value="10" required> I prefer a large, premium look <br>
                ...
                <div class="main-div">
                    ...
                    <input type="radio" name="vraag12" value="10" required> Very important! I love immersive sound <br>
                ...
                <div class="main-div">
                    ...
                    <input type="radio" name="vraag13" value="10" required> Yes, I want powerful sound <br>
                ...
                <div class="main-div">
                    ...
                    <input type="radio" name="vraag14" value="10" required> Yes, I love smart features <br>
                ...
                <div class="main-div">
                    ...
                    <input type="radio" name="vraag15" value="10" required> Yes, I use them outside a lot <br>
                ...
                <div class="main-div">
                    ...
                    <input type="checkbox" name="vraag16[]" value="sound" required> High-quality sound <br>
                ...
                <div class="main-div">
                    ...
                    <input
                            ...
                            required
                    />
                    <button type="submit">Submit</button> <!-- Dit is de submit-knop -->
                </div>
            </form>
        </main>
<!--Footer-->
